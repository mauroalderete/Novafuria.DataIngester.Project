...
{
    public class ConciliationWorkflow : ValueObjectBase<string>
    {
        protected ConciliationWorkflow(string value) : base(value)
        {
        }

        public static ConciliationWorkflow Create(string value)
        {
            ...
            return new ConciliationWorkflow(value);
        }
    }
}
